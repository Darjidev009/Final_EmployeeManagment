        ...
        <div className="container py-5">
          <div className="row g-5">
            <div className="col-lg-7">
              ...
              <p className="mb-4">
                From market research to implementation, we deliver comprehensive solutions to transform your mobile app and website development concepts into reality. We stands out as a premier company in mobile app and website development, with a specialization in designing and developing digital products.
              </p>
              ...
              >
                ...
                <div className="ps-4">
                  ...
                  <h4 className="text-primary mb-0">+91 63555 44531</h4>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-4">
              <div className="row g-5">
                <div className="col-12 wow zoomIn" data-wow-delay="0.2s">
                  ...
                  <p className="mb-0">
                  Welcome to AceCode, where excellence meets innovation. As a leading software solutions provider, we pride ourselves on being the best in the industry.                  </p>
                </div>
                <div className="col-12 wow zoomIn" data-wow-delay="0.6s">
                  ...
                  <h4>Award Winning</h4>
                  <p className="mb-0">
                  Welcome to AceCode, where excellence is recognized. As a distinguished leader in the software solutions industry, AceCode proudly boasts an array of prestigious awards and accolades. 
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-4">
              <div className="row g-5">
                <div className="col-12 wow zoomIn" data-wow-delay="0.4s">
                  ...
                  <p className="mb-0">
                  At AceCode, professionalism isn't just a trait; it's our way of life. Our dedicated team of professionals embodies the highest standards of expertise, integrity, and commitment to excellence.
                  </p>
                </div>
                <div className="col-12 wow zoomIn" data-wow-delay="0.8s">
                  ...
                  <h4>24/7 Support</h4>
                  <p className="mb-0">
                  we understand that your business doesn't operate on a 9-to-5 schedule, which is why we offer round-the-clock support to ensure that your systems are always running smoothly.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="row g-5">
            ...
            <div className="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.9s">
              <div className="position-relative bg-primary rounded h-100 d-flex flex-column align-items-center justify-content-center text-center p-5">
                ...
                To Understand Who We Are Just Visit Web Development & Digital Marketing Company
                Let’s Improve Your Business With Quality Services Of Team Acecode
                </p>
